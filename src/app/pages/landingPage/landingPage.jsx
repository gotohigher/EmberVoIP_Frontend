      ...
      <div className="LP-Body">
        <div className="LP-B-TextAndButton">
          <div className="LP-B-TAB-Text">
            EmberVOIP, now available for everyone, for free.
          </div>
          <div className="LP-B-TAB-Text2">
            Welcome to my video meeting platform. I made this to show my WebRTC
            skills. I hope you like it and maybe find it useful.
          </div>
          <div className="LP-B-TAB-Button">
            ...
            <div className="LP-B-TAB-B-JoinRoom">
              <label
                className={`LP-B-TAB-B-JR-Label${_Focused ? "Blue" : "Grey"}`}
              >
              ...
              {(_Focused || _Value.length > 0) && (
                <button
                  ...
                  style={{
                    color: Utils.idGenerator.isRoomIDValid(_Value)
                      ? "#1a73e8"
                      : "rgba(60,64,67,0.38)",
                  }}
                  onClick={() =>
