...
export default function RoomLayer(props) {
  ...
  function setRemoteThenLocalDescription(connection, offer, peerId) {
    ...
    connection
      ...
      .then(() =>
        console.log(`WebRTC:\tClient_${peerId}:\tRemote description set`)
      );
  ...
  function RTCMessageDispatcher(msg) {
    ...
    if (msg.type === "Answer") {
      ...
      connection.PC.setRemoteDescription(msg.answer).then(() =>
        console.log(`WebRTC:\tClient_${msg.from} Remote description set`)
      );
      ...
      connection.PC.addIceCandidate(ice).then(() =>
        console.log(`WebRTC:\tAdd new ICE from Client_${msg.from}\t${ice.type}`)
      );
    }
  }
